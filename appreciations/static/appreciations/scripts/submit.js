...
reform.widgets.wizard.init = function() {
  ...
  Array.prototype.slice.apply(document.querySelector('#appreciation-form').elements).forEach(function(e) {
    elements[e.name] = $(e);
  });
  ...
  */
  ...
  $('#appreciation-form').on('submit', function(e) {
    e.preventDefault();
    $('.appreciation-violation-form').block({
    ...
    $.ajax({
      ...
      $('.appreciation-violation-form').unblock();
    });
    return false;
  })
