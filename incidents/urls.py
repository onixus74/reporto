...
urlpatterns = patterns('',
                       ...
                       #url(r'^$', 'incidents.views.index', name='reports'),
                       ...
                       url(r'^categories/', include('incidents_categories.urls', namespace="categories")),
                       url(r'^features/',   include('incidents_features.urls', namespace="features")),
                       url(r'^victims/',    include('incidents_victims.urls', namespace="victims")),
                       )
