...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'reports_report', 'location')

        # Deleting field 'ThankReport.location'
        db.delete_column(u'reports_thankreport', 'location')


    def backwards(self, orm):
        # Adding field 'Report.location'
        db.add_column(u'reports_report', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ThankReport.location'
        db.add_column(u'reports_thankreport', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
