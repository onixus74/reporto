...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Victim.education'
        db.alter_column(u'reports_victim', 'education', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))

    def backwards(self, orm):

        # Changing field 'Victim.education'
        db.alter_column(u'reports_victim', 'education', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'reports.victim': {
            ...
            'education': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200'}),
