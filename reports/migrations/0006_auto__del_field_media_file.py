...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'reports_media', 'file')


        # Changing field 'Media.url'
        db.alter_column(u'reports_media', 'url', self.gf('django.db.models.fields.URLField')(default=None, max_length=300))

    def backwards(self, orm):
        # Adding field 'Media.file'
        db.add_column(u'reports_media', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


        # Changing field 'Media.url'
        db.alter_column(u'reports_media', 'url', self.gf('django.db.models.fields.URLField')(max_length=300, null=True))
    ...
    models = {
        ...
        u'reports.report': {
            ...
            'media': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['reports.Media']", 'null': 'True', 'symmetrical': 'False'}),
