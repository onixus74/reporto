...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.report'
        db.delete_column(u'reports_comment', 'report_id')


    def backwards(self, orm):
        # Adding field 'Comment.report'
        db.add_column(u'reports_comment', 'report',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['reports.Report']),
                      keep_default=False)
