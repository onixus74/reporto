...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reports_report', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.User']))

        # Changing field 'Comment.created_by'
        db.alter_column(u'reports_comment', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.User']))

        # Changing field 'Victim.user'
        db.alter_column(u'reports_victim', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Report.created_by'
        db.alter_column(u'reports_report', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Account']))

        # Changing field 'Comment.created_by'
        db.alter_column(u'reports_comment', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Account']))

        # Changing field 'Victim.user'
        db.alter_column(u'reports_victim', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Account'], null=True))
