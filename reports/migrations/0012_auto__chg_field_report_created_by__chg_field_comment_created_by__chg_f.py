...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'reports.comment': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Account']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'reports.victim': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Account']", 'null': 'True', 'blank': 'True'})
        }
    }
