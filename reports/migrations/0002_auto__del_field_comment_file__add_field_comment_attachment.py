...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.file'
        db.delete_column(u'reports_comment', 'file')

        # Adding field 'Comment.attachment'
        db.add_column(u'reports_comment', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comment.file'
        db.add_column(u'reports_comment', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Comment.attachment'
        db.delete_column(u'reports_comment', 'attachment')
