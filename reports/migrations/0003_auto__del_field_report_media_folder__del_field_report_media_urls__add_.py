...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report.media_folder'
        db.delete_column(u'reports_report', 'media_folder')

        # Deleting field 'Report.media_urls'
        db.delete_column(u'reports_report', 'media_urls')
        ...
        db.add_column(u'reports_media', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=300, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Media.file'
        db.alter_column(u'reports_media', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding field 'Report.media_folder'
        db.add_column(u'reports_report', 'media_folder',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Report.media_urls'
        db.add_column(u'reports_report', 'media_urls',
        ...
        db.delete_column(u'reports_media', 'url')


        # Changing field 'Media.file'
        db.alter_column(u'reports_media', 'file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'reports.report': {
            ...
            'media': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['reports.Media']", 'symmetrical': 'False'}),
