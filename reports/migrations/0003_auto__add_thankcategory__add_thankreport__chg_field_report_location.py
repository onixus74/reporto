...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_thankcategory', (
        ...
        db.send_create_signal(u'reports', ['ThankCategory'])

        # Adding model 'ThankReport'
        db.create_table(u'reports_thankreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.ThankCategory'])),
        ...
        db.send_create_signal(u'reports', ['ThankReport'])

        # Adding M2M table for field media on 'ThankReport'
        m2m_table_name = db.shorten_name(u'reports_thankreport_media')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('thankreport', models.ForeignKey(orm[u'reports.thankreport'], null=False)),
        ...
        db.alter_column(u'reports_report', 'location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'ThankCategory'
        db.delete_table(u'reports_thankcategory')

        # Deleting model 'ThankReport'
        db.delete_table(u'reports_thankreport')

        # Removing M2M table for field media on 'ThankReport'
        db.delete_table(db.shorten_name(u'reports_thankreport_media'))


        # Changing field 'Report.location'
        db.alter_column(u'reports_report', 'location', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'reports.thankcategory': {
            'Meta': {'object_name': 'ThankCategory'},
            'definition': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'reports.thankreport': {
            'Meta': {'ordering': "['-datetime']", 'object_name': 'ThankReport'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reports.ThankCategory']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.User']"}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
